...
public class Config {
    ...
    public static final String TESTUSER_1_NAME = "admin";
    public static final String TEST_FIXTURES_PATH = "/E:/Users/IdeaProjects/springtest/src/test/fixture";

    public static final String CHAIN_CODE_NAME = "tokenpoint";
    public static final String CHAIN_CODE_PATH = "github.com/liquid";
    public static final String CHAIN_CODE_VERSION = "1.0";

    public static final String FOO_CHANNEL_NAME = "businesschannel";
...
//                    DEFAULT_CONFIG));
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpcs://127.0.0.1:7051, peer1.org1.example.com@grpcs://127.0.0.1:8051,peer1.org1.example.com@grpcs://127.0.0.1:8059");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpcs://127.0.0.1:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpcs://127.0.0.1:7053,peer1.org1.example.com@grpcs://127.0.0.1:8053");
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.peer_locations", "peer0.org2.example.com@grpcs://127.0.0.1:9051,peer1.org2.example.com@grpcs://127.0.0.1:10051");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.orderer_locations", "orderer.example.com@grpcs://127.0.0.1:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.eventhub_locations", "peer0.org2.example.com@grpcs://127.0.0.1:8053, peer1.org2.example.com@grpcs://127.0.0.1:8058");
             */
            ...
            for (Map.Entry<String, SampleOrg> org : sampleOrgs.entrySet()) {
                ...
                System.out.println("-- catls :" + runningFabricCATLS);
                if (runningFabricCATLS) {
                    String cert = "crypto-config/peerOrganizations/DNAME/ca/ca.DNAME-cert.pem".replaceAll("DNAME", domainName);
    ...
    private Properties getEndPointProperties(final String type, final String name) {
        ...
        String str_cert=getChannelPath()+ "/crypto-config/ordererOrganizations".replace("orderer", type)+"/" +domainName+"/"+ type + "s/"+ name+ "/tls/server.crt";
